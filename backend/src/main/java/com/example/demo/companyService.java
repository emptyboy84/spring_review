...
public class CompanyService {
   ...
   public Map<String, Object> getBusinessStatus(String regNum) {
      try {
         ...
         result.put("status", dataNode.path("b_stt_cd").asText()); // 프론트엔드 호환용
         result.put("tax_type", dataNode.path("tax_type").asText());
         result.put("company", "(상태조회 완료)"); // 상태조회 API는 회사명을 제공하지 않음

         System.out.println("조회 성공: " + result);
